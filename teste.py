...
while cap.isOpened():
 ...
 # verifica qual jogada foi escolhida pelo jogador 2
    ...
    # Verifica se a jogada atual é diferente da jogada anterior
    if jogada1 != jogada1_anterior:
        jogada1_anterior = jogada1
        cv2.rectangle(crop1, (0, 0), (crop1_w, crop1_h), (0, 0, 0), -1)
        if jogada1 == 'pedra':
            cv2.putText(crop1, 'PEDRA', (50, int(crop1_h/2)), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 255, 0), 10)
        elif jogada1 == 'papel':
            cv2.putText(crop1, 'PAPEL', (50, int(crop1_h/2)), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 255, 0), 10)
        elif jogada1 == 'tesoura':
            cv2.putText(crop1, 'TESOURA', (50, int(crop1_h/2)), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 255, 0), 10)
    
    if jogada2 != jogada2_anterior:
        jogada2_anterior = jogada2
        cv2.rectangle(crop2, (0, 0), (crop2_w, crop2_h), (0, 0, 0), -1)
        if jogada2 == 'pedra':
            cv2.putText(crop2, 'PEDRA', (50, int(crop2_h/2)), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 0, 255), 10)
        elif jogada2 == 'papel':
            cv2.putText(crop2, 'PAPEL', (50, int(crop2_h/2)), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 255, 0), 10)
        elif jogada2 == 'tesoura':
            cv2.putText(crop2, 'TESOURA', (50, int(crop2_h/2)), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 255, 0), 10)
